...
public class TestVod {
     ...
     * @param title 在阿里云显示的文件名称
     * @param fileName 文件在本地的路径和名称
     */
    private static void uploadToAliyun(String accessKeyId,String accessKeySecret,String title,String fileName) {
     ...
     * 根据视频id获取视频凭证
     */
    private static void getAcsByid() {
        //根据视频id获取视频凭证
        ...
        try {
            ...
            //想request对象里面设置视频id
            request.setVideoId("049657793f04403385a115a90e6b1390");
     ...
     * 根据视频id获取视频地址
     */
    private static void getVodByid() {
        DefaultAcsClient client = null;
        try {
